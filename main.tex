...
\begin{theorem}[Esempio con Dimostrazione]
...
\begin{itemize}
    \item \code{\textbackslash{}ref\{label\}} --- Numero dell'elemento
    \item \code{\textbackslash{}eqref\{label\}} --- Riferimento a equazione con parentesi
    \item \code{\textbackslash{}cref\{label\}} --- Riferimento intelligente (consigliato)
    \item \code{\textbackslash{}Cref\{label\}} --- Come cref ma con maiuscola
\end{itemize}
